...
bool ChatBotApp::OnInit()
{
    ...
    ChatBotFrame* chatBotMainFrame = new ChatBotFrame(wxT("Udacity ChatBot"));
    chatBotMainFrame->Show(true);
...
void ChatBotFrameImagePanel::paintEvent([[maybe_unused]] wxPaintEvent &evt)
{
    wxPaintDC dc(this);
    render(dc);
}
